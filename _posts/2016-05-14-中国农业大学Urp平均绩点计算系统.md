...
**1.此系统仅适用于中国农业大学内部的urp查询系统，初始意愿是方便同学们查询自己的平均绩点，免去复杂的一个个累加计算.**

**2.本项目为开源项目，由于博主精力有限，希望更多的同学能够参与其中，为更多的人带来便利.**

**3.本文主要讲解系统所有代码的含义以及思路，方便以后的改进更加合理，科学。**

**4.最新下载地址和使用说明：[http://zhangyunhao.me/CAU-Urp_Calculating/](http://zhangyunhao.me/CAU-Urp_Calculating/)：**
...
**2.初始编译系统以及ide:Mac Os 10.11 64-bit ,pycharm for mac 5.0.4 pro**
...
**1.获取用户的学号以及密码,并检验输入是否正确（Module1）**


**2.使用用户的学号以及密码登录Urp，并获取其cookie(Module2)**


**3.使用cookie获取成绩表单，即全部及格成绩（Module3）**


**4.创建存储在列表的类 ，并将课程信息存入(Module4)**


**5.使用cookie获取指导性教学计划的真实成绩，并更新类的列表（Module5）**


**6.使用cookie获取不及格成绩列表，并更新不及格成绩的绩点（Module6）**


**7.创建新的列表，将类列表每个学期区分开（Module7）**


**8.在类列表中删除双学位以及CET4-6等一些不影响GPA的成绩（Moduele8）**


**9.计算GPA并打印出来（Module9）**
